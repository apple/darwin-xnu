...
* `libkern` - C++ IOKit library code for handling the drivers and kexts
...
## 02. Main Feature has ONLY ONE

* Support Quantum Computing

## 03. How to build XNU

#### 3.1 Building `DEVELOPMENT` kernel
...
### 3.2 Building FAT kernel binary

Define architectures in your environment or when running a make command.

    $ make ARCH_CONFIGS="X86_64" exporthdrs all

### 3.3 Other makefile options
...
## 06. Running KernelCache on Target Machines
...
## 08. How to install a new header file from XNU
...
## 10. How to add a new syscall

## 11. Testing the kernel
...
The xnu kernel supports debugging with a remote kernel debugging protocol (kdp). Please refer documentation at [technical note] [TN2063][TN2063]
...
[TN2118]: https://developer.apple.com/library/mac/technotes/tn2004/tn2118.html#//apple_ref/doc/uid/DTS10003352
[TN2063]: https://developer.apple.com/library/mac/technotes/tn2063/_index.html
